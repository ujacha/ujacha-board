...
class DateUtilsTest {
    ...
    public void test_ago_ko() {
        ...
        final String ago_59s = DateUtils.ago(before_59s, now, locale);

        final LocalDateTime before_60s = now.minus(60, ChronoUnit.SECONDS);
        final String ago_60s = DateUtils.ago(before_60s, now, locale);

        final LocalDateTime before_123s = now.minus(123, ChronoUnit.SECONDS);
        final String ago_123s = DateUtils.ago(before_123s, now, locale);

        final LocalDateTime before_31m = now.minus(31, ChronoUnit.MINUTES);
        final String ago_31m = DateUtils.ago(before_31m, now, locale);

        final LocalDateTime before_61m = now.minus(61, ChronoUnit.MINUTES);
        final String ago_61m = DateUtils.ago(before_61m, now, locale);

        final LocalDateTime before_12h = now.minus(12, ChronoUnit.HOURS);
        final String ago_12h = DateUtils.ago(before_12h, now, locale);

        final LocalDateTime before_24h = now.minus(24, ChronoUnit.HOURS);
        final String ago_24h = DateUtils.ago(before_24h, now, locale);

        final LocalDateTime before_30h = now.minus(30, ChronoUnit.HOURS);
        final String ago_30h = DateUtils.ago(before_30h, now, locale);

        final LocalDateTime before_49h = now.minus(49, ChronoUnit.HOURS);
        final String ago_49h = DateUtils.ago(before_49h, now, locale);

        final LocalDateTime before_40d = now.minus(40, ChronoUnit.DAYS);
        final String ago_40d = DateUtils.ago(before_40d, now, locale);

        final LocalDateTime before_400d = now.minus(400, ChronoUnit.DAYS);
        final String ago_400d = DateUtils.ago(before_400d, now, locale);
    ...
    public void test_ago_en() {
        ...
        final String ago_80d = DateUtils.ago(before_80d, now, locale);

        final LocalDateTime before_400d = now.minus(400, ChronoUnit.DAYS);
        final String ago_400d = DateUtils.ago(before_400d, now, locale);

        final LocalDateTime before_800d = now.minus(800, ChronoUnit.DAYS);
        final String ago_800d = DateUtils.ago(before_800d, now, locale);
    ...
    public void test_ago_short() {
        ...
        final String ago_59s = DateUtils.ago(before_59s, now, shortDisplay);

        final LocalDateTime before_60s = now.minus(60, ChronoUnit.SECONDS);
        final String ago_60s = DateUtils.ago(before_60s, now, shortDisplay);

        final LocalDateTime before_123s = now.minus(123, ChronoUnit.SECONDS);
        final String ago_123s = DateUtils.ago(before_123s, now, shortDisplay);

        final LocalDateTime before_31m = now.minus(31, ChronoUnit.MINUTES);
        final String ago_31m = DateUtils.ago(before_31m, now, shortDisplay);

        final LocalDateTime before_61m = now.minus(61, ChronoUnit.MINUTES);
        final String ago_61m = DateUtils.ago(before_61m, now, shortDisplay);

        final LocalDateTime before_12h = now.minus(12, ChronoUnit.HOURS);
        final String ago_12h = DateUtils.ago(before_12h, now, shortDisplay);

        final LocalDateTime before_24h = now.minus(24, ChronoUnit.HOURS);
        final String ago_24h = DateUtils.ago(before_24h, now, shortDisplay);

        final LocalDateTime before_30h = now.minus(30, ChronoUnit.HOURS);
        final String ago_30h = DateUtils.ago(before_30h, now, shortDisplay);

        final LocalDateTime before_49h = now.minus(49, ChronoUnit.HOURS);
        final String ago_49h = DateUtils.ago(before_49h, now, shortDisplay);

        final LocalDateTime before_40d = now.minus(40, ChronoUnit.DAYS);
        final String ago_40d = DateUtils.ago(before_40d, now, shortDisplay);

        final LocalDateTime before_400d = now.minus(400, ChronoUnit.DAYS);
        final String ago_400d = DateUtils.ago(before_400d, now, shortDisplay);
